 ...
 node(POD_LABEL) {
   ...
   stage('GetCode') {
    ...
    stage('Copy Car') {
          ...
          fileOperations([fileCopyOperation(excludes: '', flattenFiles: true, includes: 'CIAPTaskParentProject/*CompositeApplication/target/*.car', renameFiles: false, sourceCaptureExpression: '', targetLocation: 'Config/carbonapps/', targetNameExpression: '')])
          println "Copy Jar files"
          fileOperations([fileCopyOperation(excludes: '', flattenFiles: true, includes: 'CIAPTaskParentProject/*/target/*.jar', renameFiles: false, sourceCaptureExpression: '', targetLocation: 'Config/lib/', targetNameExpression: '')])    
      }
