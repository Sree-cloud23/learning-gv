...
String getServiceAccount(Map config = [:]) {
  ...
  def input = "${params.Region}" + '-' + "${params.Envir}" + '-' + "${params.Component}"
  def result = ''
  switch (input) {
      case 'EU-QA-IKON':
          result = 'ikon-eu-test-ssh'
          break
      case 'EU-PROD-IKON':
          result = 'ikon-eu-prod-ssh'
          break
      case 'EU-QA-ROOCA':
          result = 'rooca-eu-test-ssh'
          break
      case 'EU-PROD-ROOCA':
          result = 'rooca-eu-prod-ssh'
          break
      case 'NA-DEV-IKON':
          result = 'ikon-na-dev-ssh'
          break
      case 'NA-QA-IKON':
          result = 'ikon-na-test-ssh'
          break
      case 'NA-DEV-ROOCA':
          result = 'rooca-na-dev-ssh'
          break
      case 'NA-QA-ROOCA':
          result = 'rooca-na-test-ssh'
          break
      case 'NA-PROD-ROOCA':
          result = 'rooca-na-prod-ssh'
          break
      case 'NA-PROD-IKON':
          result = 'ikon-na-prod-ssh'
          break
  }
  return result
}
