           ...
           dir('platform') {
              gitCheckout(
                           branch: "${GtiBranchPlf}", url: "https://github.com/capgemini-gadm/${GitRepoPlf}", credentialsId: "git-devops")
                            ...
                            def exists = fileExists "platform/${AppName}/${Proj}/${Region}/${Envir}/EFS"
                            def existsefs = fileExists "platform/${AppName}/${Proj}/${Region}/${Envir}/efs/"
                            echo "===${exists}==="
                            if (exists) {
                                  sh "cp -Rpv platform/${AppName}/${Proj}/${Region}/${Envir}/EFS/* EFS/"
