...
def call(body) {
  ...
  print "GitRepo=${GitRepo} GtiBranch=${GtiBranch} Envir=${Envir} Region=${Region} AppEnv=${AppEnv} HostName=${HostnameOverride}"
      ...
      /*def ClusterValue = GetEnv
        ...
        switch (ClusterValue) {
            ...
            case 'EU-PROD':
                ...
                break
            case 'NA-DEV':
                clustername = 'eks-sandpit'
                break
            case 'NA-QA':
                clustername = 'eks-sandpit-test'
                break
            case 'NA-PROD':
                clustername = 'eks-sandpit-prod'
                break
      }*/
